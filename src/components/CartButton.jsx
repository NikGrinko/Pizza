...
const CartButton = (props) => {
    return (
        <div >
            <button className="cart-button">520 ₽ <div className='cart-button__line'></div> <svg className='cart-button__basket' width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
